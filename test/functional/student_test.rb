...
describe "Empresas chachis for students" do
  ...
  def create_company (name)
    @companies_collection.insert({ "verified" => true, "name" => "Company #{name}", "hiring" => true , "keywords" => [] })
  end

  def create_company_with_keyword(keywords)
    @companies_collection.insert({ "verified" => true, "name" => "Company name", "hiring" => true, "keywords" => keywords })
  end
